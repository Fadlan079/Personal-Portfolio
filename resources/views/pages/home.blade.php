...
<section id="home" class="hero-section relative min-h-screen flex items-center justify-center overflow-hidden z-10">
    ...
    <div class="hero-floats pointer-events-auto">
        <a href="https://github.com/Fadlan079" target="_blank" class="float-icon icon-github group" data-depth="1.2">
            <i class="fa-brands fa-github"></i>
            <span class="float-label">NODE_GH</span>
        </a>

        <a href="https://www.linkedin.com/in/fadlan-firdaus-148344386" target="_blank" class="float-icon icon-linkedin group" data-depth="0.9">
            <i class="fa-brands fa-linkedin"></i>
            <span class="float-label">NODE_IN</span>
        </a>

        <a href="https://instagram.com/fdln007" target="_blank" class="float-icon icon-instagram group" data-depth="0.7">
            <i class="fa-brands fa-instagram"></i>
            <span class="float-label">NODE_IG</span>
        </a>

        <a href="mailto:fadlanfirdaus220@gmail.com" class="float-icon icon-mail group" data-depth="0.6">
            <i class="fa-solid fa-envelope"></i>
            <span class="float-label">NODE_MAIL</span>
        </a>

        <a href="https://wa.me/6282210732928" target="_blank" class="float-icon icon-whatsapp group" data-depth="1.0">
            <i class="fa-brands fa-whatsapp"></i>
            <span class="float-label">NODE_WA</span>
        </a>
    </div>
    ...
    @if ($showClock ?? true)
        <div class="hidden md:flex fixed top-8 left-6 z-50 flex-col gap-1 font-mono tracking-widest cursor-default">
            ...
            <div id="hero-live-clock" data-format="{{ $clockFormat ?? '24' }}" data-seconds="{{ $showSeconds ?? '1' }}" class="text-text text-sm font-semibold opacity-80">
                00:00:00 WITA
            </div>
    ...
    <div class="hidden md:block fixed top-7.5 right-4 z-50">
        <div class="flex justify-center">
            @if (!session('is_login'))
                <a href="/login" class="cta-btn relative overflow-hidden px-4 py-2 border-2 border-border text-text font-mono text-xs font-bold uppercase tracking-widest" style="--cta-bubble-color: var(--color-primary);">
            ...
            @else
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button type="submit" class="group flex items-center gap-3 px-4 py-2 text-xs font-mono uppercase tracking-widest text-muted hover:bg-red-500/10 hover:text-red-500 transition-colors border border-border hover:border-red-500/20">
    ...
    <div class="hero-center relative z-10 text-center max-w-3xl -top-10">
        <div class="text-center">
            <span data-i18n="hero.collaboration" class="hero-badge inline-flex items-center gap-2 px-4 py-1 mb-6 rounded-none border border-border bg-surface text-sm font-mono tracking-widest text-muted uppercase"></span>
            ...
            <p class="hero-desc max-w-xl mx-auto mb-5 text-sm md:text-base leading-loose tracking-wide text-muted/80 relative">
            ...
            <div class="flex gap-4 flex-wrap justify-center text-sm font-mono uppercase tracking-widest font-bold mt-2">
                <a href="{{ route('portofolio.projects') }}" class="cta-btn relative overflow-hidden px-6 py-3 bg-primary text-background border-2 border-primary" style="--cta-bubble-color: var(--color-bg);">
                    <span class="cta-bubble"></span>
                    <span class="cta-text relative z-10 flex items-center gap-2">
                        <i class="fa-regular fa-folder-open"></i> <span>/DIR_PROJECTS</span>
                    </span>
                </a>
                
                <a href="{{ route('portofolio.contact') }}" class="cta-btn relative overflow-hidden px-6 py-3 border-2 border-border text-text" style="--cta-bubble-color: var(--color-primary);">
                    <span class="cta-bubble"></span>
                    <span class="cta-text relative z-10 flex items-center gap-2">
                        <i class="fa-solid fa-satellite-dish text-primary"></i> <span>INIT_COMMS()</span>
                    </span>
                </a>
            </div>
        </div>
