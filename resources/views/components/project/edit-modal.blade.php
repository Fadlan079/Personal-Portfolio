...
<div id="projectEditModal" class="fixed inset-0 z-70 hidden items-center justify-center bg-black/60 backdrop-blur-sm p-4">
    ...
    <div
        ...
        <form id="editForm" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div class="grid grid-cols-2 gap-6 text-sm">
                <div>
                    ...
                    <input type="text" name="role" id="editRole"
                        class="mt-1 w-full border border-border  px-4 py-2 focus:ring-1 focus:ring-primary focus:outline-none">
                </div>
            ...
            <!-- Responsibilities -->
            <div class="space-y-2">
                <label for="editResponsibilities"
                    class="text-muted uppercase tracking-wide text-xs">Responsibilities</label>
