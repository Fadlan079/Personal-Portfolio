<section id="contact" class="py-24 px-5 max-w-4xl mx-auto relative z-10 mb-12">
    ...
    <div class="relative bg-surface p-10 md:p-14 shadow-[0_20px_50px_-15px_rgba(0,0,0,0.15)] border border-border transform md:rotate-1 hover:rotate-0 transition-transform duration-500 rounded-sm">
        ...
        <div class="relative z-10 pl-6 sm:pl-12">
            ...
            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-6 w-full mt-6">
                ...
                <a href="{{ route('portofolio.contact') }}"
                   class="w-full sm:w-auto px-6 py-3 bg-[var(--color-warning)] text-text border-2 border-[var(--color-text)] font-mono text-xs md:text-sm font-black uppercase tracking-[0.2em] transition-all duration-300 transform md:-rotate-1 hover:rotate-0 hover:-translate-y-1 shadow-[4px_4px_0px_var(--color-text)] active:shadow-[0px_0px_0px_var(--color-text)] active:translate-y-[4px] active:translate-x-[4px] flex items-center justify-center gap-3">
