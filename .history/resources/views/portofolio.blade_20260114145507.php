...
<!-- Education -->
<section id="education" class="py-24 bg-surface">
  <div class="max-w-6xl mx-auto px-6">

    <!-- Heading -->
    <div class="text-center mb-16">
      <h3 class="text-4xl font-extrabold mb-3">
        Riwayat <span class="text-primary">Pendidikan</span>
      </h3>
      <p class="text-muted max-w-2xl mx-auto">
        Perjalanan pendidikan yang membentuk dasar skill dan minat saya
        di bidang teknologi dan pengembangan web.
      </p>
    </div>
    ...
    <div class="relative">
      ...
      <!-- Vertical Line -->
      <div class="absolute left-1/2 top-0 h-full w-[2px]
                  bg-border -translate-x-1/2 hidden md:block"></div>
      ...
      <div class="space-y-12">
        ...
        <div class="md:grid md:grid-cols-2 md:gap-10 items-center">
          ...
          <div class="md:text-right">
            <span class="text-sm text-muted">2023 - Sekarang</span>
            <h4 class="text-xl font-semibold mt-1">
              SMK – PPLG
            </h4>
            <p class="text-muted mt-2 max-w-md md:ml-auto">
              Fokus mempelajari pemrograman web, backend Laravel,
              database MySQL, REST API, dan dasar deployment Linux server.
            </p>
          </div>
        ...
        <div class="md:grid md:grid-cols-2 md:gap-10 items-center">
          <!-- Dot -->
          <div class="relative hidden md:flex justify-center md:order-2">
            <span
              class="w-5 h-5 rounded-full bg-primary/70
          ...
          <div class="md:order-1">
            <span class="text-sm text-muted">2020 - 2023</span>
            <h4 class="text-xl font-semibold mt-1">
              SMP
            </h4>
            <p class="text-muted mt-2 max-w-md">
              Mulai tertarik dengan dunia IT, komputer,
              dan belajar dasar logika pemrograman secara mandiri.
            </p>
          </div>
        </div>
        ...
        <div class="md:grid md:grid-cols-2 md:gap-10 items-center">
          <!-- Left -->
          <div class="md:text-right">
            <span class="text-sm text-muted">2014 - 2020</span>
            <h4 class="text-xl font-semibold mt-1">
              SD
            </h4>
            <p class="text-muted mt-2 max-w-md md:ml-auto">
              Pendidikan dasar dan awal mengenal teknologi
          ...
          <div class="relative hidden md:flex justify-center">
            <span
              class="w-5 h-5 rounded-full bg-primary/50
