...
>
  ...
  <div class="absolute inset-0 -z-10">
    <div class="absolute top-1/4 left-1/2 -translate-x-1/2 w-[500px] h-[500px]
  ...
  <div class="text-center max-w-3xl">
    ...
    <!-- Description -->
    <p class="text-muted max-w-2xl mx-auto mb-8 leading-relaxed">
      Fokus membangun aplikasi web modern menggunakan
      <strong class="text-text">Laravel</strong>,
      arsitektur backend yang rapi, frontend responsif,
      serta deployment di
    ...
    <!-- Tech Stack -->
    <div class="mt-10 flex justify-center gap-6 text-muted text-sm flex-wrap">
